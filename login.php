...
if (isset($_SESSION['user_id']) && isset($_SESSION['role'])) {
    ...
    switch ($role) {
        case 'admin':
            ...
            exit();
        // 👇 AJOUT POUR LE DIRECTEUR PAYS (DP) 👇
        case 'dp':
        ...
        case 'finance':
            ...
            exit();
        default:
            // Par défaut, c'est un demandeur (chef de projet) ou administration
    ...
    <div class="container">
        <div class="card login-card mx-auto">
            <div class="card-header">
               <img src="logo.png" alt="Swisscontact Logo" class="logo-img">
                <p class="text-muted small">connexion</p>
            </div>
