...
// =========================================================================
// GESTION DE L'AJOUT D'UNE PROFORMA REÇUE MANUELLEMENT
// =========================================================================
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_proforma_recue'])) {
    ...
    if (empty($fournisseur_nom) || empty($montant) || empty($date_reception)) {
        ...
        // Upload du fichier PDF scanné dans le SOUS-DOSSIER
        if (isset($_FILES['fichier_proforma']) && $_FILES['fichier_proforma']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($ext, ['pdf', 'jpg', 'png', 'jpeg'])) {
                ...
                // MODIFICATION : Utilisation du sous-dossier offres_fournisseurs
                                                ...
                                                <tr class="<?= $row_class ?>">
                                                    ...
                                                    <td class="text-end">
                                                        <?php if (!empty($reponse['fichier'])): ?>
                                                            <a href="uploads/offres_fournisseurs/<?= htmlspecialchars($reponse['fichier']) ?>" class="btn btn-sm btn-outline-secondary" title="Voir la proforma" target="_blank"><i class="bi bi-file-earmark-pdf"></i></a>
                                                        <?php endif; ?>
