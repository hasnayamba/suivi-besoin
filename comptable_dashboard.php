    ...
    <div class="flex-fill d-flex flex-column main-content overflow-auto">
        <header class="bg-white border-bottom px-4 py-3">
             <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1 fw-bold text-dark"><i class="bi bi-calculator me-2 text-primary"></i>Tableau de Bord Comptabilité</h2>
                    <p class="text-muted mb-0 small">Dossiers en attente de vérification et validation de paiement</p>
                </div>
