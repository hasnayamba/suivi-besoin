    ...
    <div class="p-3">
        <ul class="nav nav-pills flex-column">
            <li class="nav-item mb-1">
                <a class="nav-link d-flex align-items-center <?= ($currentPage == 'convention_dashboard.php') ? 'active' : '' ?>" href="convention_dashboard.php">
                    <i class="bi bi-grid-1x2 me-2"></i>Tableau de bord
                </a>
            </li>
            <li class="nav-item mb-1">
                <a class="nav-link d-flex align-items-center <?= ($currentPage == 'ajouter_convention.php') ? 'active' : '' ?>" href="ajouter_convention.php">
