...
?>
<!DOCTYPE html>
<html lang="fr"><head><title>Dossiers Rejetés</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"><link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.0/font/bootstrap-icons.css" rel="stylesheet"></head>
<body class="bg-light">
    ...
    <nav class="sidebar bg-white border-end" style="width: 260px;">
        ...
        <div class="p-3">
            <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item mb-1"><a class="nav-link active" href="comptable_rejetes.php"><i class="bi bi-x-circle me-2"></i>Dossiers Rejetés</a></li>
            </ul>
        </div>
    </nav>
    
    <div class="flex-fill d-flex flex-column">
        <header class="bg-white border-bottom px-4 py-3"><h2 class="mb-1">Dossiers Rejetés</h2></header>
