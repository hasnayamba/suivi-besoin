                        ...
                        <div class="card-body p-4">
                            ...
                            <?php if (!empty($besoin['fichier'])): ?>
                                <div class="bg-light p-3 rounded border text-center mt-4">
                                   ...
                                   <a href="uploads/<?= rawurlencode($besoin['dossier_upload']) ?>/<?= rawurlencode($besoin['fichier']) ?>" target="_blank" class="btn btn-outline-primary btn-sm mt-1">
    <i class="bi bi-view me-1"></i>visionner le fichier joint
</a>
                                </div>
                            <?php endif; ?>
                        </div>
