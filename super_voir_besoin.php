...
<head>
    <meta charset="UTF-8">
    <title>Visualisation besoin - <?= htmlspecialchars($besoin['id']) ?></title>
    ...
    <style>
        ...
        .toolbar { background: #fff; padding: 10px 20px; border-radius: 8px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center; }
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php if (!empty($besoin['fichier'])): ?>
                    <iframe src="viewer.php?file=<?= urlencode($besoin['fichier']) ?>"></iframe>
                <?php else: ?>
